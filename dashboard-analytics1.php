        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="html/ltr/vertical-collapsed-menu-template/index.html"><span class="brand-logo">
                            <img viewbox="0 0 139 95" version="1.1" src="assets/images/we.png" width="" height="">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class=' nav-item'><a class='d-flex align-items-center' href='#'><img src='assets/images/icons/icons8-globe-96.png' class='position-left' alt='' width='29' height=''>&nbsp;&nbsp;<span class='menu-title text-truncate' data-i18n='Invoice'>Operations Area</span></a>
                    <ul class='menu-content'>
                        <li><a class='d-flex align-items-center' href='analytics.html'><i data-feather='circle'></i><span class='menu-item' data-i18n='List'>Analytic</span></a>
                        </li>
                        <li><a class='d-flex align-items-center' href='map.html'><i data-feather='circle'></i><span class='menu-item' data-i18n='Preview'>Map</span></a>
                        </li>
                            ...
                            <div class="card card-congratulations">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-center">
                                        <h1 class="mb-1 text-white">Congratulations Weststar,</h1>
